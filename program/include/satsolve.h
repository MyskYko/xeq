...
// satexp2.cpp
extern std::vector<int> inputvariables;
extern void SatExp2(nodecircuit::Circuit &gf, nodecircuit::Circuit &rf, std::vector<bool> &result, int gate_encoding = 0, FILE *dumpdimacs = NULL);
